...
export type Tile = { handle: string; title: string; image?: string };

/**
 * The sliding category tiles.
 *
 * Split from the section around it because Embla needs the browser, while the
 * tiles themselves come from the database — so ShopByCategory.tsx does the
 * fetching on the server and hands them down.
 */
export default function CategoryCarousel({ tiles }: { tiles: Tile[] }) {
