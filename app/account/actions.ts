...
async function siteOrigin(): Promise<string> {
  ...
  // In dev the link must come back to the same origin that started the signup:
  // the PKCE verifier cookie lives on localhost, so a link pointing at the
  // production domain can never be redeemed and always reads as "expired".
